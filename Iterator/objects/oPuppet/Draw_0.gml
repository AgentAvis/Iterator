...
draw_sprite_ext(body.sprite,body.index,body.x,body.y,image_xscale,image_yscale,body.angle,body.blend,body.alpha)
draw_sprite_ext(sMoon_robe,body.index,body.x,body.y,image_xscale,image_yscale,body.angle,body.blend,body.alpha)

draw_sprite_ext(head.sprite,head.index,head.x,head.y,image_xscale,image_yscale,head.angle,head.blend,head.alpha)

draw_sprite_ext(arm1.sprite,arm1.index,arm1.x,arm1.y,image_xscale,image_yscale,arm1.angle,arm1.blend,arm1.alpha)
draw_sprite_ext(sMoon_sleeve,arm1.index,arm1.x,arm1.y,image_xscale,-image_yscale,arm1.angle,arm1.blend,arm1.alpha)

draw_sprite_ext(arm2.sprite,arm2.index,arm2.x,arm2.y,image_xscale,image_yscale,arm2.angle,arm2.blend,arm2.alpha)
draw_sprite_ext(sMoon_sleeve,arm2.index,arm2.x,arm2.y,image_xscale,image_yscale,arm2.angle,arm2.blend,arm2.alpha)
